...
function CriarTriggers($conn) {
    ...
    $sqlCriandoTriggers = "CREATE TRIGGER IF NOT EXISTS processamento_extracao_after_delete
        AFTER DELETE ON processamento_extracao
        FOR EACH ROW
        BEGIN
            INSERT INTO log_processamento_extracao (id, alteracao) VALUES (OLD.id, 'deletado');
        END;
    ";
