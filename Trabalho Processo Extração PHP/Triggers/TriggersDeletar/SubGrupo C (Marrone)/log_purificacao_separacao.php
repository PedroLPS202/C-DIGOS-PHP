...
function CriarTriggers($conn) {
    ...
    $sqlCriandoTriggers = "CREATE TRIGGER IF NOT EXISTS purificacao_separacao_after_delete
        AFTER DELETE ON purificacao_separacao
        FOR EACH ROW
        BEGIN
            INSERT INTO log_purificacao_separacao (id, alteracao) VALUES (OLD.id, 'deletado');
        END;
    ";
