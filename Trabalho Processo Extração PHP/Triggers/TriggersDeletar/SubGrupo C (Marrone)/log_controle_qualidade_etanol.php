...
function CriarTriggers($conn) {
    ...
    $sqlCriandoTriggers = "CREATE TRIGGER IF NOT EXISTS controle_qualidade_etanol_after_delete
        AFTER DELETE ON controle_qualidade_etanol
        FOR EACH ROW
        BEGIN
            INSERT INTO log_controle_qualidade_etanol (id, alteracao) VALUES (OLD.id, 'deletado');
        END;
    ";
