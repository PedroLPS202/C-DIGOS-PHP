...
function CriarTriggers($conn) {
    ...
    $sqlCriandoTriggers = "CREATE TRIGGER IF NOT EXISTS controle_processo_after_delete
        AFTER DELETE ON controle_processo
        FOR EACH ROW
        BEGIN
            INSERT INTO log_controle_processo (id, alteracao) VALUES (OLD.id, 'deletado');
        END;
    ";
