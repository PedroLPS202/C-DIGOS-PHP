...
function CriarTriggers($conn) {
    ...
    $sqlCriandoTriggers = "CREATE TRIGGER IF NOT EXISTS moagem_trituracao_after_delete
        AFTER DELETE ON moagem_trituracao
        FOR EACH ROW
        BEGIN
            INSERT INTO log_moagem_trituracao (id, alteracao) VALUES (OLD.id, 'deletado');
        END;
    ";
