...
function CriarTriggers($conn) {
    ...
    $sqlCriandoTriggers = "CREATE TRIGGER IF NOT EXISTS fermentacao_destilacao_after_delete
        AFTER DELETE ON fermentacao_destilacao
        FOR EACH ROW
        BEGIN
            INSERT INTO log_fermentacao_destilacao (id, alteracao) VALUES (OLD.id, 'deletado');
        END;
    ";
