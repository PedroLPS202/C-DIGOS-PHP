...
function CriarTriggers($conn) {
    ...
    $sqlCriandoTriggers = "CREATE TRIGGER IF NOT EXISTS controle_processo_after_insert
        AFTER INSERT ON controle_processo
        FOR EACH ROW
        BEGIN
            INSERT INTO log_controle_processo (id, alteracao) VALUES (NEW.id, 'inserção');
        END;
    ";
