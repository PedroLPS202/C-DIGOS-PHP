<?php      //Feito por Otávio Augusto Oliveira e Gustavo De OLiveira Vital.
...
function CriarTriggers($conn) {
    ...
    $sqlCriandoTriggers = "CREATE TRIGGER IF NOT EXISTS fermentacao_destilacao_after_update
        AFTER UPDATE ON fermentacao_destilacao
        FOR EACH ROW
        BEGIN
            INSERT INTO log_fermentacao_destilacao (id, alteracao) VALUES (NEW.id, 'atualização');
        END;
    ";
